    ...
    public function getMatchesParallel(Request $request) {
        ...
        try {
            if ($puuid) {
                ...
                if (!$accData->successful()) {
                    return redirect('/error')->with('message', 'Failed to get account data from puuid');
                }
            ...
            if (!$puuid) {
                ...
                if (!$puuidResponse->successful()) {
                    return redirect('/error')->with('message', 'Failed to get puuid from nickname and tagline');
                }
            ...
            if (!$summonerResponse->successful()) {
                return redirect('/error')->with('message', 'Failed to get summoner data');
            }
            ...
            if (!$matchesResponse->successful()) {
                return redirect('/error')->with('message', 'Failed to get match IDs');
            }
            ...
            return redirect('/error')->with('message', 'An unexpected error occurred.');
        }
    }
